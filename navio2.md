...
2단계
./waf --targets examples/UART_Test --upload  (x)
./waf --targets examples/UART_test --upload (o) 
...
출처 https://github.com/ArduPilot/ardupilot_wiki/blob/master/dev/source/docs/debugging-with-gdb-on-stm32.rst
...
objs/AP_HAL/UNKNOWN 
objs/AP_HAL_ChibiOS 
objs/AP_HAL_ChibiOS/AP_DAL_Standalone 
...
objs/Filter 
objs/GCS_MAVLink 
objs/GCS_MAVLink/AntennaTracker 
